<header class="bg-primary"
    ...
    <nav
        ...
        <ul class="hidden lg:flex items-center space-x-6 font-bold">
            <li class="group"><x-nav-link.desktop.alt route="home" label="nav.home" /></li>
            <li class="group"><x-nav-link.desktop.alt route="properties.index" label="nav.properties.index" /></li>
            <li class="group"><x-nav-link.desktop.alt route="contact" label="nav.contact" /></li>
            <li class="group">
                <div x-data="{
                    open: false,
                    toggle() {
