<dl id="details" class="bg-white rounded-sm pt-3 pb-10 px-6" style="box-shadow: 0px 1px 5px rgba(0, 0, 0, 0.25)">
    ...
    <dd class="mt-8 lg:px-5">
        <dl class="grid grid-cols-3 xl:grid-cols-5 justify-items-start 2xl:justify-items-center gap-6 2xl:gap-10">
            <div class="grid justify-items-center gap-3">
                ...
                <dd class="font-semibold text-primary-gray">منزل</dd>
            </div>
            <div class="grid justify-items-center gap-3">
                <dt class="flex items-center space-x-2">
                    ...
                    <span class="text-primary-gray">التصنيف</span>
                </dt>
                <dd class="font-semibold text-primary-gray">سكني</dd>
            </div>
            <div class="grid justify-items-center gap-3">
                <dt class="flex items-center space-x-2">
