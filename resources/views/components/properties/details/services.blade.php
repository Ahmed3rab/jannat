<div class="py-6 border-b border-[#9BA2A8]">
    <dt class="text-primary font-semibold text-2xl">توزيع الوحدات الخدمية</dt>
</div>
            ...
            <dd>
                <dl
                    ...
                    <div class="grid justify-items-center gap-3">
                        ...
                        <dd class="font-semibold text-primary-gray">2</dd>
                    </div>
                    <div class="grid justify-items-center gap-3">
                        <dt class="flex items-center space-x-2">
                    ...
                    <div class="grid justify-items-center gap-3">
                        ...
                        <dd class="font-semibold text-primary-gray">كامل</dd>
                    </div>
                    <div class="grid justify-items-center gap-3">
                        <dt class="flex items-center space-x-2">
