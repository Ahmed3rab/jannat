...
<div class="mt-6 flex items-center justify-between">
        ...
        <section id="latest" class="flex flex-col justify-center mt-44 w-full bg-primary">
            <div class="-mt-16 mx-auto w-full max-w-7xl bg-white px-8 pb-10 pt-12 rounded-lg shadow-lg"
